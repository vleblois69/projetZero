...
public class Window {
	...
	static List<Label> listeAliens = new ArrayList<Label>();
	...
	public static void genererAliens(Composite compJeu, Display display) {
		...
		for (int i = 0; i < NB_LIGNES; i++) {
			...
			for (int j = 0; j < NB_ALIENS_PAR_LIGNE; j++) {
				...
				positionAlien += 60;
				lblAlien.setImage(
						new Image(display, "D:/Mes Documents/Cours Tests Unitaires/projetZero/src/images/alien.png"));
				listeAliens.add(lblAlien);
			}
		}
	}
